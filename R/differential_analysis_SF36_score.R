...
dml.fit <- DMLfit.multiFactor(bs.sub, design = design.df, smoothing = TRUE,  smoothing.span = 150, formula = dss.formula)
...
save(bs.sub, test.result, file = "Results/SF_Score/dssResults.SF36_Score.smooth150.rdata")
